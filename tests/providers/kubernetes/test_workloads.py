...
class K8sWorkloadTest(unittest.TestCase):
  ...
  def testPodIsCoveredByWorkloadSameLabels(self, workload_pod_match_labels):
    ...
    workload = k8s_mocks.MakeMockK8sWorkload('name', 'namespace')
  ...
  @mock.patch.object(workloads.K8sWorkload, '__abstractmethods__', set())
  @mock.patch.object(workloads.K8sWorkload, '_PodMatchLabels')
  def testPodIsCoveredByWorkloadDifferentLabels(self, workload_pod_match_labels):
  ...
  @mock.patch.object(workloads.K8sWorkload, '__abstractmethods__', set())
  @mock.patch.object(workloads.K8sWorkload, '_PodMatchLabels')
  def testPodIsCoveredByWorkloadDifferentNamespace(self, workload_pod_match_labels):
  ...
  def testListPodInSameNamespace(self, mock_list_pod, workload_pod_match_labels):
    """Tests that workload pods are listed in the same namespace."""
    mock_namespace = 'namespace-xdwvkhrj'

    # Override abstract method
    workload_pod_match_labels.return_value = self.mock_match_labels
    workload = k8s_mocks.MakeMockK8sWorkload('name', mock_namespace)
  ...
  @mock.patch.object(workloads.K8sWorkload, '_PodMatchLabels')
  @mock.patch('kubernetes.client.CoreV1Api.list_namespaced_pod')
  def testListPodWithWorkloadLabels(self, mock_list_pod, workload_pod_match_labels):
  ...
  def testReplicaSetNonCascadingDeletionArgs(self, mock_delete):
    ...
    workload = k8s_mocks.MakeMockK8sReplicaSet('name-cvjcofvh', 'namespace-gonnujrl')
  ...
  def testDeploymentNonCascadingDeletionArgs(self, mock_delete):
    ...
    workload = k8s_mocks.MakeMockK8sDeployment('name-cvjcofvh', 'namespace-gonnujrl', None)
    workload.Delete(cascade=False)
  ...
  def testDeploymentReplicaSet(self, mock_list_replica_set):
    ...
    mock_list_replica_set_response.items = [
        k8s_mocks.MakeV1ReplicaSet(
            name='replicaset-0', template_spec_labels={}),
        k8s_mocks.MakeV1ReplicaSet(
            name='replicaset-1', template_spec_labels={}),
        k8s_mocks.MakeV1ReplicaSet(
            name='replicaset-2', template_spec_labels={}),
        k8s_mocks.MakeV1ReplicaSet(
            name='replicaset-3', template_spec_labels={}),
        k8s_mocks.MakeV1ReplicaSet(
            name='replicaset-4',
        ...
        k8s_mocks.MakeV1ReplicaSet(
            name='replicaset-5', template_spec_labels={}),
        k8s_mocks.MakeV1ReplicaSet(
            name='replicaset-6', template_spec_labels={}),
        k8s_mocks.MakeV1ReplicaSet(
            name='replicaset-7', template_spec_labels={}),
        k8s_mocks.MakeV1ReplicaSet(
            name='replicaset-8', template_spec_labels={}),
        k8s_mocks.MakeV1ReplicaSet(
            name='replicaset-9', template_spec_labels={}),
    ]

    mock_list_replica_set.return_value = mock_list_replica_set_response

    deployment_response = k8s_mocks.MakeV1Deployment(
        template_spec_labels={'app': 'nginx'}, match_labels={'app': 'nginx'})
    deployment = k8s_mocks.MakeMockK8sDeployment(
        'deployment', 'default', deployment_response)

    self.assertEqual(deployment._ReplicaSet().name, 'replicaset-4')

  @mock.patch('kubernetes.client.AppsV1Api.list_namespaced_replica_set')
  def testDeploymentReplicaSetError(self, mock_list_replica_set):
    """Tests error is raised if no ReplicaSet matches Deployment."""
    mock_list_replica_set_response = mock.Mock()
    mock_list_replica_set_response.items = [
        k8s_mocks.MakeV1ReplicaSet(
            name='replicaset-0', template_spec_labels={}),
