...
class AZStorageTest(unittest.TestCase):
  ...
  @mock.patch('azure.mgmt.storage.v2021_02_01.operations._storage_accounts_operations.StorageAccountsOperations.list_keys')
  @mock.patch('azure.mgmt.storage.v2021_02_01.operations._storage_accounts_operations.StorageAccountsOperations.begin_create')
