...
class AZStorageTest(unittest.TestCase):
  ...
  @mock.patch('azure.mgmt.storage.v2022_05_01.operations._storage_accounts_operations.StorageAccountsOperations.list_keys')
  @mock.patch('azure.mgmt.storage.v2022_05_01.operations._storage_accounts_operations.StorageAccountsOperations.begin_create')
